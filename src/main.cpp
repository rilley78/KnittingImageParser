...
int main(int, char**)
{
    ...
    *link = "misc/examples/test.png";
    ...
    SDL_Window* window = SDL_CreateWindow("Knitting Image Parser", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1280, 720, window_flags);
    if (window == nullptr)
    {
    ...
    io.ConfigFlags |= ImGuiConfigFlags_ViewportsEnable;       // Multiple viewport
